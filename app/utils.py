...
def GeneratorScript():
    ...
    print("ruta data Generador", result_path)
...
def Bts():
    ...
    print("ruta data BTS", result_path)
    dataframe = pd.read_excel(result_path)
    dataframe = DataClean(dataframe)
    return dataframe
...
def ServiceManager():
    ...
    print("ruta data service", result_path)
...
def FaseDDA():
    ...
    print("ruta data Fase1A_1B_conDDA", result_path)
